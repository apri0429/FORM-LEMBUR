            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px 40px', marginBottom: '20px', fontSize: '10pt' }}>
              <div>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <tbody>
                    <tr><td style={{ width: '110px', padding: '4px 0', color: '#555' }}>Division</td><td>: <strong>{form.kodeDivisi || '-'}</strong></td></tr>
                    ...
                    <tr><td style={{ padding: '4px 0', color: '#555' }}>Overtime Day</td><td>: <strong>{formatLemburPada(form.lemburPada)}</strong></td></tr>
                  </tbody>
                </table>
              </div>
              <div>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <tbody>
                    <tr><td style={{ width: '110px', padding: '4px 0', color: '#555' }}>Requested By</td><td>: <strong>{form.diperintahOleh || '-'}</strong></td></tr>
                    <tr><td style={{ padding: '4px 0', color: '#555' }}>Submission Date</td><td>: <strong>{form.tanggalPengajuan || '-'}</strong></td></tr>
